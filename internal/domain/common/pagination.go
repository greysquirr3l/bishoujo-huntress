...
// NewPagination creates a new Pagination object with the given parameters
func NewPagination(page, perPage, totalItems, totalPages int) *Pagination {
	return &Pagination{
		Page:       page,
		PerPage:    perPage,
...
// DefaultPagination creates a new Pagination object with default values
